...
<head>
	...
	<?php endif; ?>
	<?php wp_head(); ?>
	<link rel="stylesheet" href="http://electro-galaxy.badcrabs.com/wp-content/themes/open-shop/css/custom.css" type="text/css">
</head>
	...
	<div id="page" class="openshop-site  <?php echo esc_attr($classes); ?>">
		<header>
			<a class="skip-link screen-reader-text" href="#content">
				<?php _e('Skip to content', 'open-shop'); ?>
			</a>
			...
			<?php if (class_exists('WooCommerce')) {
				do_action('open_shop_below_header');
			} ?>
			<!-- end below-header -->
		</header> <!-- end header -->